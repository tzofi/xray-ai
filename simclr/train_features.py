...
parser.add_argument('--image_dir', type=str, default='/home/tz28264/data/512_dataset.h5',
                    help='Path to dataset (default: data')
parser.add_argument('--feature-size', type=int, default=256,
                    help='Feature output size (default: 128')
parser.add_argument('--batch_size', type=int, default=66, metavar='N',
...
parser.add_argument('--output_dir', type=str, default='runs_1',
                    help='logging directory (default: runs)')
